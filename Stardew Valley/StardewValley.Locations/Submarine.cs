...
public class Submarine : GameLocation
{
	...
	public override void UpdateWhenCurrentLocation(GameTime time)
	{
		...
		else if (submerged.Value && !doneUntilReset)
		{
			...
			{
				Vector2 pos = new Vector2(Game1.random.Next(384, map.DisplayWidth - 64), 320f);
				int which = Game1.random.Next(3);
				Game1.background.tempSprites.Add(new TemporaryAnimatedSprite
				{
					motion = new Vector2(0f, -1f + (float)which * 0.2f),
					yStopCoordinate = 1,
					texture = submarineSprites,
					sourceRect = new Microsoft.Xna.Framework.Rectangle(132 + which * 8, 20, 8, 8),
					animationLength = 1,
			...
			{
				Vector2 pos = new Vector2(1344f, Game1.random.Next(448, 704));
				Game1.background.tempSprites.Add(new TemporaryAnimatedSprite
				{
			...
			{
				Vector2 pos = new Vector2(3f, 10f) * 64f;
				Game1.background.tempSprites.Add(new TemporaryAnimatedSprite
				{
					motion = new Vector2(-0f, -1f),
