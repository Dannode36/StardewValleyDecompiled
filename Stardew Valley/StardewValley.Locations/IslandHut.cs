...
public class IslandHut : IslandLocation
{
	...
	public virtual int ShowNutHint()
	{
		...
		buried_nuts = 0;
		if (MissingTheseNuts(ref buried_nuts, "Buried_IslandWest_21_81", "Buried_IslandWest_62_76", "Buried_IslandWest_39_24", "Buried_IslandWest_88_14", "Buried_IslandWest_43_74", "Buried_IslandWest_30_75"))
		{
			valid_hints.Add(new KeyValuePair<string, int>("Strings\\Locations:NutHint_WestBuried", buried_nuts));
		}
		west_nuts += buried_nuts;
		int mussel_stone = 0;
