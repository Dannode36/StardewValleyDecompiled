...
public class Seagull : Critter
{
	...
	public override bool update(GameTime time, GameLocation environment)
	{
		...
		case 2:
		{
			...
			if (yOffset > tmpY)
			{
				environment.temporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64, 64), 150f, 8, 0, new Vector2(position.X - 32f, position.Y - 32f), flicker: false, Game1.random.NextBool(), 0.001f, 0.01f, Color.White, 1f, 0.003f, 0f, 0f));
			}
			break;
		}
		case 1:
