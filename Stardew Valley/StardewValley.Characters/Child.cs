...
public class Child : NPC
{
	...
	public void toddlerReachedDestination(Character c, GameLocation l)
	{
		...
		{
			List<FarmerSprite.AnimationFrame> animation = new List<FarmerSprite.AnimationFrame>();
			animation.Add(new FarmerSprite.AnimationFrame(20, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(21, 70, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(22, 70, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(23, 70, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(22, 999999, 0, secondaryArm: false, flip: false));
			Sprite.setCurrentAnimation(animation);
		}
