...
public class Junimo : NPC
{
	...
	private void placeStar(Character c, GameLocation l)
	{
		...
		friendly.Value = true;
		base.speed = 3;
		Game1.multiplayer.broadcastSprites(l, new TemporaryAnimatedSprite(Sprite.textureName, new Rectangle(0, 109, 16, 19), 40f, 8, 10, base.Position + new Vector2(0f, -64f), flicker: false, flipped: false, 1f, 0f, Color.White, 4f * scale.Value, 0f, 0f, 0f)
		{
