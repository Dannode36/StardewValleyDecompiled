...
public class Noise
{
	...
	public static float Generate(float x)
	{
		...
		float num = 1f - x0 * x0;
		float num2 = num * num;
		float n0 = num2 * num2 * grad(perm[i0 & 0xFF], x0);
		float num3 = 1f - x1 * x1;
		float num4 = num3 * num3;
		float n1 = num4 * num4 * grad(perm[i1 & 0xFF], x1);
		return 0.395f * (n0 + n1);
	}
	...
	public static float Generate(float x, float y)
	{
		...
		float x2 = x0 - 1f + 0.42264974f;
		float y2 = y0 - 1f + 0.42264974f;
		int ii = num % 256;
		int jj = j % 256;
