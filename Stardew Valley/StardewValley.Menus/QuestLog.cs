	...
	public override void draw(SpriteBatch b)
	{
		...
		else
		{
			...
			else
			{
				...
				{
					string parsed_text = Game1.parseText(_objectiveText[i], width: width - 192, whichFont: Game1.dialogueFont);
					bool num2 = _shownQuest is SpecialOrder o && o.objectives[i].IsComplete();
					...
					{
						OrderObjective order_objective = order.objectives[i];
